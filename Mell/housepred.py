...
def return_prediction(model,scaler,sample_json):
    ...
    M_Val = sample_json['petal width']


  

    flower = [[L_Area,Y_Built, Y_RemodAdd, M_Vnr_Area,B_SF_1,T_Bsmt_SF,S_Flr_SF,G_Liv_Area,G_Area,W_Deck_SF,O_Porch_SF,M_Val]]
...
def prediction():
    ...
    content['petal width'] = float(session['Misc_Val'])
